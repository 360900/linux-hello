# Class that simulates the functionality of opencv so Linux Hello can use v4l2 devices seamlessly
...
class pyv4l2_reader:
	""" This class was created to look as similar to the openCV features used in Linux Hello as possible for overall code cleanliness. """
