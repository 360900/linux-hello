#!/bin/bash
# Download OpenVINO face detection and re-identification models for Linux Hello
# These models run on Intel iGPU via OpenVINO for fast face unlock

set -e

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
MODEL_DIR="/usr/share/linux-hello/openvino-models"
CACHE_DIR="/var/cache/linux-hello/openvino"
